...
function findFalseNoSniffPropertyFromHelmet(context, node) {
    ...
    if (callee.type === 'Identifier' &&
        ((_a = (0, utils_1.getModuleNameOfNode)(context, callee)) === null || _a === void 0 ? void 0 : _a.value) === HELMET &&
        args.length === 1 &&
        args[0].type === 'ObjectExpression') {
        sensitive = (0, utils_1.getPropertyWithValue)(context, args[0], NO_SNIFF, false);
    }
