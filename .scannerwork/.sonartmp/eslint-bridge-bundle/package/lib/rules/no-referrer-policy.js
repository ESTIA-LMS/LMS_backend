...
function findNoReferrerPolicyPropertyFromHelmet(context, node) {
    ...
    if (args.length === 1) {
        ...
        if (isHelmetModuleNode(context, callee) && options.type === 'ObjectExpression') {
            sensitive = (0, utils_1.getPropertyWithValue)(context, options, REFERRER_POLICY, false);
        }
            ...
            if (isHelmetModuleNode(context, object) &&
                ...
                const maybePolicy = (0, utils_1.getObjectExpressionProperty)(options, POLICY);
...
function isHelmetModuleNode(context, node) {
    var _a;
    return node.type === 'Identifier' && ((_a = (0, utils_1.getModuleNameOfNode)(context, node)) === null || _a === void 0 ? void 0 : _a.value) === HELMET;
}
