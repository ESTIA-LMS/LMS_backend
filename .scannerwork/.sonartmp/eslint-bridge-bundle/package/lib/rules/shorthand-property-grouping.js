...
exports.rule = {
    ...
    create(context) {
        function raiseIssue(node, begin, end, positionMessage) {
            ...
            const message = (0, utils_1.toEncodedMessage)(`Group all shorthand properties at ${positionMessage} of this object declaration.`, secondaryNodes, secondaryMessages);
            context.report({
                message,
