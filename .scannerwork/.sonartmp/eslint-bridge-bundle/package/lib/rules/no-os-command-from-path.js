...
exports.rule = {
    ...
    create(context) {
        return {
            CallExpression: (node) => {
                const { module, method } = (0, utils_1.getModuleAndCalledMethod)(node.callee, context);
                if ((module === null || module === void 0 ? void 0 : module.value) === 'child_process' && (0, utils_1.isIdentifier)(method, ...SENSITIVE_METHODS)) {
...
function findSensitiveArgument(context, functionArgs) {
    ...
    const literalInExpression = (0, utils_1.getValueOfExpression)(context, pathArg, 'Literal');
    let stringLiteral;
    if (literalInExpression !== undefined && (0, utils_1.isStringLiteral)(literalInExpression)) {
