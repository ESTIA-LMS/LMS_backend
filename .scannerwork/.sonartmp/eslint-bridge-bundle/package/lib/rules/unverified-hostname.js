...
exports.rule = {
    ...
    create(context) {
        ...
        function checkSensitiveArgument(callExpression, sensitiveArgumentIndex) {
            ...
            const argumentValue = (0, utils_1.getValueOfExpression)(context, sensitiveArgument, 'ObjectExpression');
            if (!argumentValue) {
                return;
            }
            ...
            const unsafeRejectUnauthorizedConfiguration = (0, utils_1.getPropertyWithValue)(context, argumentValue, 'rejectUnauthorized', false);
            ...
            const checkServerIdentityProperty = (0, utils_1.getObjectExpressionProperty)(argumentValue, 'checkServerIdentity');
            ...
            if (shouldReport) {
                context.report({
                    ...
                    message: (0, utils_1.toEncodedMessage)(MESSAGE, secondaryLocations, secondaryMessages),
                });
            }
        }
        function shouldReportOnCheckServerIdentityCallBack(checkServerIdentityProperty) {
            let baseFunction;
            baseFunction = (0, utils_1.getValueOfExpression)(context, checkServerIdentityProperty.value, 'FunctionExpression');
            if (!baseFunction) {
                baseFunction = (0, utils_1.getValueOfExpression)(context, checkServerIdentityProperty.value, 'ArrowFunctionExpression');
            }
            if ((baseFunction === null || baseFunction === void 0 ? void 0 : baseFunction.body.type) === 'BlockStatement') {
                ...
                if (returnStatements.length === 0 ||
                    returnStatements.every(r => {
                        var _a;
                        return (!r.argument || ((_a = (0, utils_1.getValueOfExpression)(context, r.argument, 'Literal')) === null || _a === void 0 ? void 0 : _a.value) === true);
                    })) {
                    return true;
                }
            }
